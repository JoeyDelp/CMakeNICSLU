...
int__t _I_NicsLU_Symbolic_Cluster(void **lu, uint__t n, uint__t k, int__t *pinv,
                                  int__t *stack, int__t *flag, int__t *pend,
                                  int__t *appos, uint__t *uindex, uint__t *ulen,
                                  uint__t *aidx, uint__t arownnz) {
  int__t top;
...
int__t _I_NicsLU_Symbolic_Pipeline(void **lu, uint__t n, uint__t k,
                                   int__t *pinv, int__t *stack, int__t *flag,
                                   int__t *pend, int__t *appos, uint__t *uindex,
                                   uint__t *ulen, uint__t *aidx,
                                   uint__t arownnz, int__t *pruned) {
  int__t top;
  uint__t i, col, j, jnew;
  int__t head, pos;
  uint__t *uidx;
...
int _I_NicsLU_Pivot_Parallel(int__t diagcol, uint__t *ulen, uint__t *uip,
                             real__t tol, real__t *x, uint__t *p_pivcol,
                             real__t *p_pivot, void *lu) {
  uint__t lens1, p, i;
  uint__t last_col;
  real__t *u_row;
  real__t tx, xabs;
  ...
  *ulen = lens1; /*<==> *ulen--*/
  ...
  } else /*the pivot is the last. ppivcol=-1*/ /*the last is the maximum or the
                                                  diag is not large enough*/
  {
    pivcol = last_col;
    pivot = x[last_col];
  }
...
void _I_NicsLU_Prune_Parallel(int__t *pend, uint__t llen, uint__t *ulen,
                              int__t *pinv, int__t pivcol, uint__t *lip,
                              void **lu) {
  uint__t p, i, j, p2;
  uint__t *uip;
  uint__t ul;
