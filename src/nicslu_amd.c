...
/*it's modified from Tim Davis's AMD package, which is distributed under the GNU
 * LGPL license*/
...
void _I_NicsLU_AMDSort(uint__t n, uint__t *ai, uint__t *ap, int__t *w,
                       uint__t *ri, uint__t *rp) {
  uint__t p, p2, i, j;
...
uint__t _I_NicsLU_AAT(uint__t n, uint__t *ai, uint__t *ap, int__t *len,
                      int__t *tp) {
...
void _I_NicsLU_AAT2(uint__t n, uint__t *ai, uint__t *ap, int__t *len,
                    int__t *pe, int__t *sp, int__t *iw, int__t *tp) {
...
void _I_NicsLU_AMD(int__t n, int__t pfree, int__t iwlen, int__t *pe, int__t *iw,
                   int__t *len, int__t *work, int__t *last, int__t *next,
                   real__t alpha, int__t aggr, size_t *lu_nnz) {
  /*pe, iw, len, last, next*/
  int__t *nv, *head, *elen, *degree, *w;

  /*local integers*/
  int__t deg, degme, dext, lemax, e, elenme, eln, ilast, inext, jlast, jnext, k,
      knt1, knt2, knt3, lenj, ln, me, mindeg, nleft, nvi, nvj, nvpiv, slenme,
      wbig, we, wflg, wnvi, ok, ncmpa, dense, nel, ndense, i, j;
  uint__t hash;

  /*local pointers*/
  int__t p, p1, p2, p3, p4, pdst, pend, pj, pme, pme1, pme2, pme3, pn, psrc,
      pend2;
...
void _I_NicsLU_PostOrder(int__t n, int__t *parent, int__t *nv, int__t *fsize,
                         int__t *order, int__t *child, int__t *sibling,
                         int__t *stack) {
...
int__t _I_NicsLU_PostTree(int__t root, int__t k, int__t *child, int__t *sibling,
                          int__t *order, int__t *stack) {
  int__t f, head, h, i;
