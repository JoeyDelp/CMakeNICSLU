...
int__t _I_NicsLU_MC64ad(uint__t n, uint__t nnz, uint__t *ai, uint__t *ap,
                        real__t *ax, int__t *match, int__t *match2, uint__t liw,
                        int__t *iw, uint__t ldw, real__t *dw) {
  uint__t i, j;
  real__t *dw_max;
  real__t *dw_abs;
  real__t rinf;
  ...
  rt_ct = _I_NicsLU_MC64wd(n, nnz, ai, ap, dw_abs, match, iw, &iw[n],
                           &iw[2 * n], &iw[3 * n], &iw[4 * n], dw, dd);
...
void _I_NicsLU_MC64dd(uint__t i, uint__t n, int__t *q, real__t *d__, int__t *l,
                      uint__t iway) {
  /*i=col*/
...
void _I_NicsLU_MC64ed(int__t *qlen, uint__t n, int__t *q, real__t *d__,
                      int__t *l, uint__t iway) {
  /*qlen>=1*/
  uint__t i;
  real__t di, dk, dr;
  int__t pos, posk;
...
void _I_NicsLU_MC64fd(int__t pos0, int__t *qlen, uint__t n, int__t *q,
                      real__t *d__, int__t *l, uint__t iway) {
  uint__t i;
  real__t di, dk, dr;
  uint__t idum;
  int__t qk, pos, posk;
...
/****************************************************************************************************************/
int__t _I_NicsLU_MC64wd(uint__t n, uint__t nnz, uint__t *ai, uint__t *ap,
                        real__t *ax, int__t *iperm, int__t *jperm, int__t *out,
                        int__t *pr, int__t *q, int__t *l, real__t *u,
                        real__t *d__) {
  ...
  for (jord = 0; jord < n; ++jord) {
    ...
    /*
                    ...
                    csp: the cost of the shortest augmenting path to unassigned
       column ai(ISP): The corresponding column index is JSP*/
