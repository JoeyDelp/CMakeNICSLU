...
int__t _I_NicsLU_Symbolic(uint__t n, uint__t k, int__t *pinv, int__t *stack,
                          int__t *flag, int__t *pend, int__t *appos,
                          uint__t *uindex, uint__t *ulen, void *lu, size_t *up,
...
int _I_NicsLU_Pivot(int__t diagcol, uint__t *ulen, size_t up, real__t tol,
                    real__t *x, uint__t *p_pivcol, real__t *p_pivot, void *lu) {
  uint__t lens1, p, i;
  uint__t last_col;
  real__t *u_row;
  real__t tx, xabs;
